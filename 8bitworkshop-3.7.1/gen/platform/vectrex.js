...
// TODO: player 2
var VECTREX_KEYCODE_MAP = emu_1.makeKeycodeMap([
...
//
var VIA6522 = /** @class */ (function () {
    function VIA6522(vectrex) {
    ...
    VIA6522.prototype.reset = function () {
    ...
    ;
    VIA6522.prototype.int_update = function () {
    ...
    VIA6522.prototype.step0 = function () {
        var t2shift = 0;
        if (this.t1on) {
    ...
    VIA6522.prototype.step1 = function () {
    ...
    VIA6522.prototype.read = function (address) {
        var data;
        /* io */
        switch (address & 0xf) {
            case 0x0:
    ...
    VIA6522.prototype.write = function (address, data) {
        switch (address & 0xf) {
            case 0x0:
                this.orb = data;
    ...
    VIA6522.prototype.saveState = function () {
        return util_1.safe_extend(null, {}, this);
    };
    VIA6522.prototype.loadState = function (state) {
        util_1.safe_extend(null, this, state);
    };
    VIA6522.prototype.toLongString = function (state) {
        var s = "";
        for (var key in state) {
            s += key + ": " + util_1.hex(state[key]) + "\n";
        }
        return s;
    };
    return VIA6522;
...
var VectrexAnalog = /** @class */ (function () {
    function VectrexAnalog(vectrex) {
    ...
    VectrexAnalog.prototype.reset = function () {
        this.rsh = 128;
        this.xsh = 128;
        this.ysh = 128;
        this.zsh = 0;
    ...
    VectrexAnalog.prototype.update = function () {
    ...
    VectrexAnalog.prototype.step = function () {
        var via = this.vectrex.via;
        var sig_dx = 0;
        var sig_dy = 0;
        var sig_ramp = 0;
    ...
    VectrexAnalog.prototype.addline = function (x0, y0, x1, y1, color) {
    ...
    VectrexAnalog.prototype.saveState = function () {
        return util_1.safe_extend(null, {}, this);
    };
    VectrexAnalog.prototype.loadState = function (state) {
        util_1.safe_extend(null, this, state);
    };
    VectrexAnalog.prototype.toLongString = function (state) {
        var s = "";
        for (var key in state) {
            s += key + ": " + state[key] + "\n";
        }
    ...
    return VectrexAnalog;
}());
//
var VectrexPlatform = /** @class */ (function (_super) {
    __extends(VectrexPlatform, _super);
    function VectrexPlatform(mainElement) {
    ...
    VectrexPlatform.prototype.getPresets = function () {
        return VECTREX_PRESETS;
    };
    VectrexPlatform.prototype.start = function () {
        var _this = this;
        this.via = new VIA6522(this);
        this.alg = new VectrexAnalog(this);
        this.bios = emu_1.padBytes(new util_1.lzgmini().decode(util_1.stringToByteArray(atob(VECTREX_FASTROM_LZG))), 0x2000);
        this.ram = new Uint8Array(0x400);
        this.inputs = new Uint8Array(4);
        var mbus = {
            read: emu_1.newAddressDecoder([
                [0x0000, 0x7fff, 0, function (a) { return _this.rom && _this.rom[a]; }],
                [0xc800, 0xcfff, 0x3ff, function (a) { return _this.ram[a]; }],
                [0xd000, 0xdfff, 0xf, function (a) { return _this.via.read(a); }],
                [0xe000, 0xffff, 0x1fff, function (a) { return _this.bios && _this.bios[a]; }],
            ]),
            write: emu_1.newAddressDecoder([
                [0xc800, 0xcfff, 0x3ff, function (a, v) { _this.ram[a] = v; }],
                [0xd000, 0xd7ff, 0x3ff, function (a, v) { _this.via.write(a & 0xf, v); }],
                [0xd800, 0xdfff, 0x3ff, function (a, v) { _this.ram[a] = v; _this.via.write(a & 0xf, v); }],
            ])
        };
        this.bus = {
            read: function (a) { var v = mbus.read(a); _this.probe.logRead(a, v); return v; },
            write: function (a, v) { _this.probe.logWrite(a, v); mbus.write(a, v); }
        };
        ...
        emu_1.setKeyboardFromMap(this.video, this.inputs, VECTREX_KEYCODE_MAP); // true = always send function);
    };
    // TODO: loadControlsState
    VectrexPlatform.prototype.updateControls = function () {
    ...
    VectrexPlatform.prototype.advance = function (novideo) {
        if (!novideo)
            this.video.clear();
    ...
    VectrexPlatform.prototype.step = function () {
    ...
    VectrexPlatform.prototype.snd_update = function () {
    ...
    VectrexPlatform.prototype.getCPUState = function () {
        return this._cpu.saveState();
    };
    VectrexPlatform.prototype.loadROM = function (title, data) {
        this.rom = emu_1.padBytes(data, 0x8000);
        this.reset();
    };
    VectrexPlatform.prototype.loadBIOS = function (title, data) {
        this.bios = emu_1.padBytes(data, 0x2000);
        this.reset();
    };
    VectrexPlatform.prototype.isRunning = function () {
        return this.timer.isRunning();
    };
    VectrexPlatform.prototype.pause = function () {
        this.timer.stop();
        this.audio.stop();
    };
    VectrexPlatform.prototype.resume = function () {
        this.timer.start();
        this.audio.start();
    };
    VectrexPlatform.prototype.reset = function () {
        this._cpu.reset();
        this.via.reset();
        this.alg.reset();
    };
    VectrexPlatform.prototype.readAddress = function (addr) {
        return ((addr & 0xf000) != 0xd000) ? this.bus.read(addr) : null; // ignore I/O space
    };
    VectrexPlatform.prototype.loadState = function (state) {
    ...
    VectrexPlatform.prototype.saveState = function () {
        return {
            c: this.getCPUState(),
            b: this.ram.slice(0),
    ...
    VectrexPlatform.prototype.loadControlsState = function (state) {
        this.inputs.set(state.in);
    };
    VectrexPlatform.prototype.saveControlsState = function () {
        return {
            in: this.inputs.slice(0)
        };
    };
    VectrexPlatform.prototype.getMemoryMap = function () {
        return {
            main: [
    ...
    ;
    VectrexPlatform.prototype.getDebugCategories = function () {
        return _super.prototype.getDebugCategories.call(this).concat(['VIA6522', 'ANALOG']);
    };
    VectrexPlatform.prototype.getDebugInfo = function (category, state) {
        switch (category) {
    ...
    VectrexPlatform.prototype.startProbing = function () {
        var rec = new recorder_1.ProbeRecorder(this);
        this.connectProbe(rec);
        return rec;
    };
    VectrexPlatform.prototype.stopProbing = function () {
        this.connectProbe(null);
    };
    VectrexPlatform.prototype.connectProbe = function (probe) {
        this.probe = probe || this.nullProbe;
    };
    return VectrexPlatform;
}(baseplatform_1.Base6809Platform));
//
