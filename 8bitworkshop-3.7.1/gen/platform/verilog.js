...
exports.VL_READMEM_W = exports.VL_READMEM_Q = exports.VL_RANDOM_I = exports.VL_RAND_RESET_I = exports.vl_stop = exports.vl_finish = exports.VL_WRITEF = exports.VL_REDXOR_32 = exports.VL_MODDIVS_III = exports.VL_DIVS_III = exports.VL_MODDIV_III = exports.VL_MULS_III = exports.VL_DIV_III = exports.VL_GTES_III = exports.VL_LTES_III = exports.VL_GTS_III = exports.VL_LTS_III = exports.VL_NEGATE_I = exports.VL_EXTENDS_II = exports.VL_EXTEND_II = exports.VL_EXTENDSIGN_I = exports.VL_BITISSET_I = exports.VL_TIME_Q = exports.VL_UL = exports.vl_stopped = exports.vl_finished = void 0;
var baseplatform_1 = require("../common/baseplatform");
var emu_1 = require("../common/emu");
var audio_1 = require("../common/audio");
var util_1 = require("../common/util");
var waveform_1 = require("../ide/waveform");
...
var VERILOG_KEYCODE_MAP = emu_1.makeKeycodeMap([
...
exports.vl_finished = false;
exports.vl_stopped = false;
function VL_UL(x) { return x | 0; }
exports.VL_UL = VL_UL;
//export function VL_ULL(x) { return x|0; }
function VL_TIME_Q() { return (new Date().getTime()) | 0; }
exports.VL_TIME_Q = VL_TIME_Q;
/// Return true if data[bit] set
function VL_BITISSET_I(data, bit) { return (data & (VL_UL(1) << VL_UL(bit))); }
exports.VL_BITISSET_I = VL_BITISSET_I;
function VL_EXTENDSIGN_I(lbits, lhs) { return (-((lhs) & (VL_UL(1) << (lbits - 1)))); }
exports.VL_EXTENDSIGN_I = VL_EXTENDSIGN_I;
function VL_EXTEND_II(obits, lbits, lhs) { return lhs; }
exports.VL_EXTEND_II = VL_EXTEND_II;
function VL_EXTENDS_II(x, lbits, lhs) {
    return VL_EXTENDSIGN_I(lbits, lhs) | lhs;
}
exports.VL_EXTENDS_II = VL_EXTENDS_II;
function VL_NEGATE_I(x) { return -x; }
exports.VL_NEGATE_I = VL_NEGATE_I;
function VL_LTS_III(x, lbits, y, lhs, rhs) {
    return (VL_EXTENDS_II(x, lbits, lhs) < VL_EXTENDS_II(x, lbits, rhs)) ? 1 : 0;
}
exports.VL_LTS_III = VL_LTS_III;
function VL_GTS_III(x, lbits, y, lhs, rhs) {
    return (VL_EXTENDS_II(x, lbits, lhs) > VL_EXTENDS_II(x, lbits, rhs)) ? 1 : 0;
}
exports.VL_GTS_III = VL_GTS_III;
function VL_LTES_III(x, lbits, y, lhs, rhs) {
    return (VL_EXTENDS_II(x, lbits, lhs) <= VL_EXTENDS_II(x, lbits, rhs)) ? 1 : 0;
}
exports.VL_LTES_III = VL_LTES_III;
function VL_GTES_III(x, lbits, y, lhs, rhs) {
    return (VL_EXTENDS_II(x, lbits, lhs) >= VL_EXTENDS_II(x, lbits, rhs)) ? 1 : 0;
}
exports.VL_GTES_III = VL_GTES_III;
function VL_DIV_III(lbits, lhs, rhs) {
    return (((rhs) == 0) ? 0 : (lhs) / (rhs));
}
exports.VL_DIV_III = VL_DIV_III;
function VL_MULS_III(lbits, lhs, rhs) {
    return (((rhs) == 0) ? 0 : (lhs) * (rhs));
}
exports.VL_MULS_III = VL_MULS_III;
function VL_MODDIV_III(lbits, lhs, rhs) {
    return (((rhs) == 0) ? 0 : (lhs) % (rhs));
}
exports.VL_MODDIV_III = VL_MODDIV_III;
function VL_DIVS_III(lbits, lhs, rhs) {
...
exports.VL_DIVS_III = VL_DIVS_III;
function VL_MODDIVS_III(lbits, lhs, rhs) {
    var lhs_signed = VL_EXTENDS_II(32, lbits, lhs);
    var rhs_signed = VL_EXTENDS_II(32, lbits, rhs);
    return (((rhs_signed) == 0) ? 0 : (lhs_signed) % (rhs_signed));
}
exports.VL_MODDIVS_III = VL_MODDIVS_III;
function VL_REDXOR_32(r) {
    r = (r ^ (r >> 1));
    r = (r ^ (r >> 2));
    r = (r ^ (r >> 4));
    r = (r ^ (r >> 8));
...
exports.VL_REDXOR_32 = VL_REDXOR_32;
exports.VL_WRITEF = console.log; // TODO: $write
function vl_finish(filename, lineno, hier) {
    if (!exports.vl_finished)
        console.log("Finished at " + filename + ":" + lineno, hier);
    exports.vl_finished = true;
}
exports.vl_finish = vl_finish;
function vl_stop(filename, lineno, hier) {
    if (!exports.vl_stopped)
        console.log("Stopped at " + filename + ":" + lineno, hier);
    exports.vl_stopped = true;
}
exports.vl_stop = vl_stop;
function VL_RAND_RESET_I(bits) { return 0 | Math.floor(Math.random() * (1 << bits)); }
exports.VL_RAND_RESET_I = VL_RAND_RESET_I;
function VL_RANDOM_I(bits) { return 0 | Math.floor(Math.random() * (1 << bits)); }
exports.VL_RANDOM_I = VL_RANDOM_I;
function VL_READMEM_Q(ishex, width, depth, array_lsb, fnwords, filename, memp, start, end) {
    VL_READMEM_W(ishex, width, depth, array_lsb, fnwords, filename, memp, start, end);
}
exports.VL_READMEM_Q = VL_READMEM_Q;
function VL_READMEM_W(ishex, width, depth, array_lsb, fnwords, filename, memp, start, end) {
    ...
    barr = barr.filter(function (x) { return x != 0; }); // ignore zeros
    barr.reverse(); // reverse it
    var strfn = util_1.byteArrayToString(barr); // convert to string
    // parse hex/binary file
    var strdata = ui_1.current_project.getFile(strfn);
    if (strdata == null)
        throw Error("Could not $readmem '" + strfn + "'");
    var data = strdata.split('\n').filter(function (s) { return s !== ''; }).map(function (s) { return parseInt(s, ishex ? 16 : 2); });
    console.log('$readmem', ishex, strfn, data.length);
    // copy into destination array
    if (memp === null)
        throw Error("No destination array to $readmem " + strfn);
    if (memp.length < data.length)
        throw Error("Destination array too small to $readmem " + strfn);
    for (i = 0; i < data.length; i++)
        memp[i] = data[i];
}
exports.VL_READMEM_W = VL_READMEM_W;
var CYCLES_PER_FILL = 20;
// SIMULATOR BASE
var VerilatorBase = /** @class */ (function () {
    function VerilatorBase() {
        this.totalTicks = 0;
        this.maxVclockLoop = 0;
        this.clk = 0;
        this.reset = 0;
    }
    VerilatorBase.prototype.vl_fatal = function (msg) {
        console.log(msg);
    };
    VerilatorBase.prototype.ticks = function () { return this.totalTicks; };
    VerilatorBase.prototype.setTicks = function (T) { this.totalTicks = T | 0; };
    VerilatorBase.prototype.__reset = function () {
    ...
    VerilatorBase.prototype.__unreset = function () {
        if (this.reset !== undefined) {
            this.reset = 0;
        }
    };
    VerilatorBase.prototype.tick2 = function () {
        this.clk = 0;
        this.eval();
        this.clk = 1;
        this.eval();
    };
    VerilatorBase.prototype.eval = function () {
        ...
        while (__Vchange) {
            ...
            if (++__VclockLoop > 100) {
                this.vl_fatal("Verilated model didn't converge");
            }
        }
    ...
    VerilatorBase.prototype._eval_initial_loop = function (vlSymsp) {
        vlSymsp.TOPp = this;
        ...
        while (__Vchange) {
            ...
            __Vchange = this._change_request(vlSymsp);
            if (++__VclockLoop > 100) {
                this.vl_fatal("Verilated model didn't DC converge");
            }
        }
    };
    return VerilatorBase;
}());
// PLATFORM
var VerilogPlatform = function (mainElement, options) {
    ...
    var _VerilogPlatform = /** @class */ (function (_super) {
        __extends(_VerilogPlatform, _super);
        function _VerilogPlatform() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        _VerilogPlatform.prototype.getPresets = function () { return VERILOG_PRESETS; };
        _VerilogPlatform.prototype.setVideoParams = function (width, height, clock) {
            videoWidth = width;
            videoHeight = height;
            cyclesPerFrame = clock;
            maxVideoLines = height + 40;
        };
        _VerilogPlatform.prototype.start = function () {
            var _this = this;
            video = new emu_1.RasterVideo(mainElement, videoWidth, videoHeight, { overscan: true });
            video.create();
            poller = emu_1.setKeyboardFromMap(video, switches, VERILOG_KEYCODE_MAP, function (o, key, code, flags) {
            ...
            // setup mouse click
            video.vcanvas.click(function (e) {
                if (!gen)
                    return; // must have created emulator
                if (!e.ctrlKey) {
                    //setFrameRateUI(60);
                    return; // ctrl key must be down
                }
                ui_1.setFrameRateUI(1.0 / 2048);
                var pos = emu_1.getMousePos(video.canvas, e);
                var new_y = Math.floor(pos.y);
                var clock = 0;
                while (framey != new_y || clock++ > 200000) {
                    _this.setGenInputs();
                    _this.updateVideoFrameCycles(1, true, false);
                    gen.__unreset();
                }
            });
        };
        // TODO: pollControls() { poller.poll(); }
        _VerilogPlatform.prototype.resize = function () {
            if (this.waveview)
                this.waveview.recreate();
        };
        _VerilogPlatform.prototype.setGenInputs = function () {
            useAudio = (audio != null);
        ...
        _VerilogPlatform.prototype.updateVideoFrame = function () {
        ...
        _VerilogPlatform.prototype.isScopeVisible = function () {
            return this.split.getSizes()[1] > 2; // TODO?
        };
        // TODO: merge with prev func  
        _VerilogPlatform.prototype.advance = function (novideo) {
            this.setGenInputs();
        ...
        _VerilogPlatform.prototype.refreshVideoFrame = function () {
            this.updateInspectionFrame();
            video.updateFrame();
            this.updateInspectionPostFrame();
        };
        _VerilogPlatform.prototype.refreshScopeOverlay = function () {
            // TODO
        };
        _VerilogPlatform.prototype.updateScopeFrame = function () {
        ...
        _VerilogPlatform.prototype.updateScope = function () {
        ...
        _VerilogPlatform.prototype.updateFrame = function () {
            if (!gen)
                return;
            if (this.hasvideo)
        ...
        _VerilogPlatform.prototype.updateInspectionFrame = function () {
            useAudio = false;
        ...
        _VerilogPlatform.prototype.updateInspectionPostFrame = function () {
            if (inspect_obj && inspect_sym) {
        ...
        _VerilogPlatform.prototype.updateVideoFrameCycles = function (ncycles, sync, trace) {
            ncycles |= 0;
        ...
        _VerilogPlatform.prototype.snapshotTrace = function () {
        ...
        _VerilogPlatform.prototype.fillTraceBuffer = function (count) {
        ...
        _VerilogPlatform.prototype.getSignalMetadata = function () {
            return trace_signals;
        };
        _VerilogPlatform.prototype.getSignalData = function (index, start, len) {
            // TODO: not efficient
        ...
        _VerilogPlatform.prototype.printErrorCodeContext = function (e, code) {
        ...
        _VerilogPlatform.prototype.loadROM = function (title, output) {
            var mod;
            if (output.code) {
                // is code identical?
                if (current_output && current_output.code == output.code) {
                    ...
                    trace_signals = trace_signals.filter(function (v) { return !v.name.startsWith("__V"); }); // remove __Vclklast etc
                    for (var _i = 0, trace_signals_1 = trace_signals; _i < trace_signals_1.length; _i++) {
                        var v = trace_signals_1[_i];
                    ...
                    if (this.hasvideo) {
                        var IGNORE_SIGNALS_1 = ['clk', 'reset'];
                        trace_signals = trace_signals.filter(function (v) { return IGNORE_SIGNALS_1.indexOf(v.name) < 0; }); // remove clk, reset
                        $("#speed_bar").show();
                        $("#run_bar").show();
                        $("#xtra_bar").show();
                    }
        ...
        _VerilogPlatform.prototype.restartAudio = function () {
            // stop/start audio
        ...
        _VerilogPlatform.prototype.isRunning = function () {
            return timer && timer.isRunning();
        };
        _VerilogPlatform.prototype.pause = function () {
            timer.stop();
            if (audio)
                audio.stop();
        };
        _VerilogPlatform.prototype.resume = function () {
            timer.start();
            if (audio)
                audio.start();
        };
        _VerilogPlatform.prototype.setFrameRate = function (rateHz) {
            frameRate = rateHz;
        ...
        _VerilogPlatform.prototype.getFrameRate = function () { return frameRate; };
        _VerilogPlatform.prototype.poweron = function () {
            gen._ctor_var_reset();
            this.reset();
        };
        _VerilogPlatform.prototype.reset = function () {
            if (!gen)
                return;
            gen.__reset();
            trace_index = 0;
        ...
        _VerilogPlatform.prototype.tick = function () {
            gen.tick2();
        };
        _VerilogPlatform.prototype.getToolForFilename = function (fn) {
            if (fn.endsWith(".asm"))
                return "jsasm";
        ...
        _VerilogPlatform.prototype.getDefaultExtension = function () { return ".v"; };
        ;
        _VerilogPlatform.prototype.inspect = function (name) {
            if (!gen)
                return;
            if (name)
                name = name.replace('.', '_');
        ...
        // DEBUGGING
        _VerilogPlatform.prototype.getDebugTree = function () {
            return this.saveState().o;
        };
        // TODO: bind() a function to avoid depot?
        _VerilogPlatform.prototype.saveState = function () {
            var state = {
                T: gen.ticks(),
                o: util_1.safe_extend(true, {}, gen)
            };
            state.o.TOPp = null;
            return state;
        };
        _VerilogPlatform.prototype.loadState = function (state) {
            gen = util_1.safe_extend(true, gen, state.o);
            gen.setTicks(state.T);
            gen.TOPp = gen;
            //console.log(gen, state.o);
        };
        _VerilogPlatform.prototype.saveControlsState = function () {
            return {
                p1x: video.paddle_x,
                p1y: video.paddle_y,
                sw0: switches[0],
        ...
        _VerilogPlatform.prototype.loadControlsState = function (state) {
        ...
        return _VerilogPlatform;
    }(baseplatform_1.BasePlatform)); // end of inner class
