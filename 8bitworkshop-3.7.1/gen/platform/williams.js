...
var WilliamsPlatform = function (mainElement, proto) {
    ...
    var DEFENDER_KEYCODE_MAP = emu_1.makeKeycodeMap([
        [emu_1.Keys.A, 4, 0x1],
    ...
    var ROBOTRON_KEYCODE_MAP = emu_1.makeKeycodeMap([
    ...
    // Defender
    var ioread_defender = emu_1.newAddressDecoder([
    ...
    var iowrite_defender = emu_1.newAddressDecoder([
        ...
        [0x0, 0xfff, 0, function (a, v) { console.log('iowrite', util_1.hex(a), util_1.hex(v)); }],
    ]);
    var memread_defender = emu_1.newAddressDecoder([
    ...
    var memwrite_defender = emu_1.newAddressDecoder([
        ...
        [0, 0xffff, 0, function (a, v) { console.log(util_1.hex(a), util_1.hex(v)); }],
    ]);
    // Robotron, Joust, Bubbles, Stargate
    var ioread_williams = emu_1.newAddressDecoder([
    ...
    var iowrite_williams = emu_1.newAddressDecoder([
        [0x0, 0xf, 0xf, setPalette],
    ...
    var memread_williams = emu_1.newAddressDecoder([
    ...
    var memwrite_williams = emu_1.newAddressDecoder([
        [0x0000, 0x97ff, 0, write_display_byte],
        [0x9800, 0xbfff, 0, function (a, v) { ram.mem[a] = v; }],
    ...
    */
    this.start = function () {
        ...
        var iobus = {
            ...
            write: function (a, v) { console.log(util_1.hex(a), util_1.hex(v)); }
        };
        ...
        $(video.canvas).click(function (e) {
            ...
            if (displayPCs)
                console.log(x, y, util_1.hex(addr, 4), "PC", util_1.hex(displayPCs[addr], 4));
        });
        var idata = video.getFrameData();
        emu_1.setKeyboardFromMap(video, pia6821, ROBOTRON_KEYCODE_MAP);
    ...
    this.loadSoundROM = function (data) {
        ...
        var soundrom = emu_1.padBytes(data, 0x4000);
    ...
    this.loadROM = function (title, data) {
        if (data.length > 2) {
            ...
            rom = emu_1.padBytes(data, 0xc000);
        }
        self.reset();
    };
...
var WilliamsZ80Platform = function (mainElement) {
    this.__proto__ = new WilliamsPlatform(mainElement, baseplatform_1.BaseZ80Platform);
    // Z80 @ 4 MHz
    ...
    this.ramStateToLongString = function (state) {
        ...
        var h = blt[7] ^ 4;
        return "\nBLIT"
            + " " + util_1.hex(sstart, 4) + " " + util_1.hex(dstart, 4)
            + " w:" + util_1.hex(w) + " h:" + util_1.hex(h)
            + " f:" + util_1.hex(blt[0]) + " s:" + util_1.hex(blt[1]);
    };
};
